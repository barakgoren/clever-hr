  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center py-10 border-b border-slate-200">
        ...
        <h1 className="mt-4 text-sm font-semibold uppercase tracking-widest text-slate-500">
          {company.name}
        </h1>
        {company.description && (
          <p className="mt-2 max-w-md text-center text-sm text-slate-500">{company.description}</p>
        )}
      </div>
